class WikiSearchResultModel {
  ...
  WikiSearchResultModel({this.batchcomplete, this.mContinue, this.query});

  WikiSearchResultModel.fromJson(Map<String, dynamic> json) {
    batchcomplete = json['batchcomplete'];
    mContinue = json['continue'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.mContinue != null) {
      data['continue'] = this.mContinue.toJson();
    }
    if (this.query != null) {
